...
const tool_defs = [_]Tool{
    ...
    .{
        ...
        .properties = &.{
            ...
            P{ .name = "include_tests", .type = "boolean", .default = .{ .bool = false }, .description = "Include test_def nodes in counts." },
            P{ .name = "include_external_nodes", .type = "boolean", .default = .{ .bool = false }, .description = "Include external (phantom) nodes in counts." },
        },
        .output_properties = &.{
    ...
    .{
        ...
        .properties = &.{
            ...
            P{ .name = "external", .enum_values = &[_][]const u8{ "include", "exclude", "only" }, .default = .{ .str = "include" }, .description = "Control phantom node inclusion." },
            P{ .name = "scope" },
            P{ .name = "min_complexity", .type = "integer" },
            P{ .name = "min_lines", .type = "integer" },
            P{ .name = "has_edge", .enum_values = &edge_types },
            P{ .name = "language", .enum_values = &languages },
            P{ .name = "include_tests", .type = "boolean", .default = .{ .bool = false }, .description = "Include test_def nodes in results." },
            P{ .name = "offset", .type = "integer", .default = .{ .int = 0 } },
            P{ .name = "limit", .type = "integer", .default = .{ .int = 50 }, .maximum = 200 },
        },
        .required = &.{"query"},
        .output_properties = &.{
    ...
    .{
        ...
        .properties = &.{
            ...
            P{ .name = "include_source", .type = "boolean", .default = .{ .bool = false }, .description = "If true, include the full source code of each node." },
            P{ .name = "include_edges", .type = "boolean", .default = .{ .bool = true }, .description = "If true, include a summary of all connected edges for each node." },
        },
        .required = &.{"node_ids"},
        .output_properties = &.{
    ...
    .{
        ...
        .properties = &.{
            ...
            P{ .name = "context_lines", .type = "integer", .default = .{ .int = 0 }, .description = "Number of lines of context above and below each node." },
            P{ .name = "part", .enum_values = &[_][]const u8{ "full", "signature", "body" }, .default = .{ .str = "full" } },
        },
        .required = &.{"node_ids"},
    },
    .{
        ...
        .properties = &.{
            P{ .name = "node_ids", .one_of_string_or_array = true, .max_items = 50, .description = "One node ID or an array of node IDs." },
            P{ .name = "direction", .enum_values = &[_][]const u8{ "in", "out", "both" }, .default = .{ .str = "both" } },
            P{ .name = "edge_type", .enum_values = &edge_types },
            P{ .name = "include_external_nodes", .type = "boolean", .default = .{ .bool = false }, .description = "Include external (phantom) nodes and their edges." },
            P{ .name = "offset", .type = "integer", .default = .{ .int = 0 } },
            P{ .name = "limit", .type = "integer", .default = .{ .int = 50 }, .maximum = 200 },
        },
        .required = &.{"node_ids"},
    ...
    .{
        ...
        .properties = &.{
            ...
            P{ .name = "max_paths", .type = "integer", .default = .{ .int = 3 }, .maximum = 10 },
        },
    ...
    .{
        ...
        .properties = &.{
            ...
            P{ .name = "include_tests", .type = "boolean", .default = .{ .bool = false }, .description = "Include test_def nodes in the cursor's visible graph." },
            P{ .name = "include_external_nodes", .type = "boolean", .default = .{ .bool = false }, .description = "Include external (phantom) nodes in the cursor's visible graph." },
        },
        .output_properties = &.{
            P{ .name = "cursor_id" },
    ...
    .{
        ...
        .properties = &.{
            ...
            P{ .name = "direction", .enum_values = &[_][]const u8{ "in", "out", "both" }, .default = .{ .str = "out" } },
            P{ .name = "depth", .type = "integer", .default = .{ .int = 2 }, .maximum = 5 },
        },
        .required = &.{"cursor_id"},
    },
    .{
        ...
        .properties = &.{
            ...
            P{ .name = "kind", .enum_values = &node_kinds },
            P{ .name = "min_complexity", .type = "integer" },
            P{ .name = "max_depth_from_position", .type = "integer", .default = .{ .int = 5 } },
            P{ .name = "limit", .type = "integer", .default = .{ .int = 20 } },
        },
        .required = &.{"cursor_id"},
    },
    .{
    ...
    .{
        ...
        .properties = &.{
            ...
            P{ .name = "diff_mode", .enum_values = &[_][]const u8{ "structural", "textual", "both" }, .default = .{ .str = "structural" }, .description = "structural = AST-level, textual = raw text diff, both = combined." },
        },
        .required = &.{"node_ids"},
    },
    .{
    ...
    .{
        ...
        .properties = &.{
            P{ .name = "top_n", .type = "integer", .default = .{ .int = 10 }, .maximum = 50 },
            P{ .name = "scope" },
            P{ .name = "kind", .enum_values = &[_][]const u8{ "function", "file" }, .default = .{ .str = "function" } },
            P{ .name = "language", .enum_values = &languages },
        },
    },
    .{
        ...
        .properties = &.{
            P{ .name = "scope" },
            P{ .name = "granularity", .enum_values = &[_][]const u8{ "file", "directory" }, .default = .{ .str = "file" } },
            P{ .name = "min_coupling", .type = "number", .default = .{ .float = 0.3 } },
            P{ .name = "top_n", .type = "integer", .default = .{ .int = 10 } },
            P{ .name = "external", .enum_values = &[_][]const u8{ "include", "exclude" }, .default = .{ .str = "exclude" }, .description = "Include coupling to external deps in the analysis." },
            P{ .name = "language", .enum_values = &languages },
        },
    },
    .{
        ...
        .properties = &.{
            P{ .name = "scope" },
            P{ .name = "include_test_only", .type = "boolean", .default = .{ .bool = false } },
            P{ .name = "include_public", .type = "boolean", .default = .{ .bool = false } },
            P{ .name = "kind", .enum_values = &[_][]const u8{ "function", "type_def", "enum_def", "union_def", "constant", "all" }, .default = .{ .str = "all" } },
            P{ .name = "language", .enum_values = &languages },
            P{ .name = "offset", .type = "integer", .default = .{ .int = 0 } },
            P{ .name = "limit", .type = "integer", .default = .{ .int = 50 } },
        },
    },
    .{
    ...
    .{
        ...
        .properties = &.{
            P{ .name = "threshold", .type = "number", .minimum = 0.5, .maximum = 1.0, .default = .{ .float = 0.75 } },
            P{ .name = "scope" },
            P{ .name = "min_lines", .type = "integer", .default = .{ .int = 5 } },
            P{ .name = "include_source", .type = "boolean", .default = .{ .bool = false } },
            P{ .name = "language", .enum_values = &languages },
            P{ .name = "offset", .type = "integer", .default = .{ .int = 0 } },
            P{ .name = "limit", .type = "integer", .default = .{ .int = 10 } },
        },
    },
    .{
